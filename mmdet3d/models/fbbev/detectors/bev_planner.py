...
class BEVPlanner(CenterPoint):
    ...
    def forward_train(self,
        ...
        if self.with_pts_bbox and self.with_specific_component('motion_head'):
    ...
    def simple_test(self,
        ...
        if self.with_pts_bbox and getattr(self.pts_bbox_head, 'tracking', False) and self.with_specific_component('motion_head'):
            preds_motion_dicts = self.motion_head(
                agent_instances,
                preds_map_dicts[-1],
